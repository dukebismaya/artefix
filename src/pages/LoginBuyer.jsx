...
export default function LoginBuyer() {
  ...
  return (
    <section className="mx-auto max-w-md px-4 sm:px-6 lg:px-8 pt-10 pb-16">
      <h2 className="text-2xl font-bold gradient-text">Buyer Login</h2>
      <form onSubmit={onSubmit} className="card p-5 mt-4">
        ...
        <p className="mt-3 text-xs text-gray-400">Don't have an account? <Link to="/signup-buyer" className="text-teal-300">Sign up</Link></p>
      </form>
    </section>
  )
}
